...
public class Tokenizer implements Iterator<Token> {
    ...
    /**
     * Lexes a slash character '/'. If the slash is followed by another "/", then it
     * indicates the start of an end-of-line comment. Otherwise it represents a division sign.
     *
     * <p>May only be called when the previously read char is a slash '/'.
     *
     * @throws EOF if the end of the file is reached
     */
    private void lexSlash() throws EOF, IOException {
        if (in.peek() == '/') {
            in.next();
